...
function Register() {
    ...
    return (
        ...
        <br />
        <input type="text" value={password} onChange={(e)=>setPassword(e.target.value)} placeholder="Enter Password" className="form-control" />
        <br />
        <button onClick={singUP} className="btn btn-primary">Sing Up</button>
        </div>
    )
}
